...
export default function AppShell({ children }: { children: React.ReactNode }) {
  ...
  if (isWelcome) {
    return (
      <div className="h-full flex justify-center" style={{ background: 'var(--thamara-bg-secondary)' }}>
        <div className="h-full w-full max-w-[430px]" style={{ background: 'var(--thamara-bg)' }}>
          {children}
        </div>
      </div>
    );
  ...
  return (
    <div className="h-full flex justify-center" style={{ background: 'var(--thamara-bg-secondary)' }}>
      <div className="h-full w-full max-w-[430px] flex flex-col overflow-hidden relative" style={{ background: 'var(--thamara-bg)' }}>
        <TopBar />
